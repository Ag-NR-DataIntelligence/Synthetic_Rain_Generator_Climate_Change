...
source("https://raw.githubusercontent.com/Ag-NR-DataIntelligence/Synthetic_Rain_Generator_Climate_Change/master/Plotting%20Theme.R")
load(url("https://www.dropbox.com/s/gmq8a545i8fle7j/DtforAnalysis.rdata?dl=1"))
